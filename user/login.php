...
<div class="container">
    <div class="form-container">
        <h2><?php echo getTranslation('Login', 'ဝင်ရောက်မည်'); ?></h2>
        ...
        <p><?php echo getTranslation("Don't have an account?", "အကောင့်မရှိပါသလား?"); ?> 
            <a href="register.php"><?php echo getTranslation('Register here', 'ဤနေရာတွင် မှတ်ပုံတင်ပါ'); ?></a>
        </p>
    </div>
</div>
